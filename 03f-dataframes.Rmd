...
As a data scientist, the most common data structure you will be working with -- by far -- is a **dataframe**. But before working with dataframes, we need to understand what they are and how they should be structured. The below is largely borrowed from Hadley Wickham's excellent tutorial on "tidy data" [here](https://r4ds.had.co.nz/tidy-data.html).
