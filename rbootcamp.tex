...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"kF40/Dq\^{}t+LN[MSg\textasciigrave{}R@E\textquotesingle{}u*U"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"\#e5CT\textquotesingle{}8PUb7u}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{{-}3W)\textasciitilde{}\textgreater{}r\^{}t1J"}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-251}A squished plot.}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-252}A pretty sweet table.}
\centering
\begin{tabular}[t]{r|r}
\hline
x & y\\
