...
names(survey) <- c(
  ...
  'happy', # "How happy do you consider yourself on a scale from 1 to 5, with 1 beign extremely unhappy, 5 being extremely happy, and 3 being the average person?", 
...
6. Ask some questions of the data. Answer them through charts and tables.
