...
Up until this point we have focused on numbers which are numeric, but we can also work with words which we refer to as logical. Let's create a vector with some names of people and call it people and explore the names.
