...
## Day 5: July 8th {.unnumbered}

In the next hour and fifteen minutes you will have finished a report for your client. So check off the boxes on the list below and then share your RMarkdown in slack as well as your report as a pdf.

**1.** Choose the best RMarkdown script and share it with everyone on your team and make sure it runs.

**2.** Knit your report. Do you like the way it looks? Does it answer the questions that your client originally asked for? (**Hint: look at the email below**). Edit your RMarkdown to make your descriptives section have the information that you want and need. 
...
**3.** Make 2-3 visuals of any of the following topics and include it in your paper: Age, Status marital, Level study, Previous pregnacy, Previous deliveries, Others diagnosis, Self reported malaria diagnosis, Malaria treatment, or ANC how many.

**4.** Write a short summary of what you would like the client to know about your analysis or any other extra information. 

**5.** Are all of your names on the report?

**6.** Is your code fully commented?

**5.** Once you are happy with the report you created, share one RMarkdown per group and one Report per group in slack and you are officially done with the DRC data! Come back into the classroom for a goodbye to the KEMRI & DataLab sesssions. 
